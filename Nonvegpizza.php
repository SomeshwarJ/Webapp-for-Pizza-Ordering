...
<head>
  ...
  <link rel="stylesheet" href="Nonveg.css" type="text/css">
</head>
...
<body>
  <div class="top" style="height: 550px;">
    <nav>
      <a href="index.php">
        <div class="head">
          <img src="https://seeklogo.com/images/P/pizza-logo-42816D88BE-seeklogo.com.png">
      ...
      <a href="Contact.html" style="float: left; font-family: Optima, sans-serif;">CONTACT</a>
      <?php
    ...
    <div class="content">
      ...
      <div class="delivery">
        <img src="https://micdn-13a1c.kxcdn.com/images/sg/content-images/zero_contact_delivery.jpg">
      </div>
    </div>
  </div>

  <div class="menuhead" style="height: 2400px;">
       <h1><a href="Vegpizza.php" style="color:black;">VEG PIZZA</a> | <a href="Nonvegpizza.php" style="color:blue;">NON-VEG PIZZA</a> | <a href="Sides.php" style="color:black;">SIDES</a></h1>
    ...
    <?php
      ...
      $sql = "SELECT * FROM `nonvegpizza`";
      if ($result = $mysqli -> query($sql)) 
      {
        while ($row = $result -> fetch_array()) 
        {
          ?>
          <form method="post" action="Nonvegpizza.php?image=<?php echo $row['images']?>&name=<?php echo $row['name']?>&prize=<?php echo $row['prize'] ?>&size=<?php echo $row['size'] ?>">
          <div style="height: 770px;float: left;">
            <div class="gallery1">
              <div class="gallery2">
                <img src="<?php echo $row['images'] ?>" style="margin-top:50px; margin-left: 60px;margin-bottom: 13px; width: 250px; height: 270px;">
                <div class="desc1">
    ...
    if (isset($_POST['addtocart'])) 
    {
      ...
      if ($result = $mysqli -> query($sql)) 
      {
        ...
        echo '<script>window.location="Nonvegpizza.php"</script>';
      }

      else 
      {
        echo '<script>window.alert("Item is already added");</script>';
        echo "<script>location.href='Nonvegpizza.php'</script>";
      }
    }
    ?>
  </div>
