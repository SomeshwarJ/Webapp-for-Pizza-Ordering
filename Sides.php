...
<head>
  ...
  <link rel="stylesheet" href="sides.css" type="text/css">
</head>
...
<body>
  ...
  <div class="menuhead" style="height: 1500px;">    <h1><a href="Vegpizza.php" style="color:black;">VEG PIZZA</a> | <a href="Nonvegpizza.php" style="color:black;">NON-VEG PIZZA</a> | <a href="Sides.php" style="color:blue;">SIDES</a></h1>
    ...
    <?php
      ...
      if ($result = $mysqli -> query($sql)) 
      {
        ...
        {
          ?>
          <form method="post" action="Sides.php?image=<?php echo $row['images']?>&name=<?php echo $row['name']?>&prize=<?php echo $row['prize'] ?>">
    ...
    if (isset($_POST['addtocart'])) 
    {
      ...
      if ($result = $mysqli -> query($sql)) 
      {
        ...
        echo '<script>window.location="Sides.php"</script>';
      }

      else 
      {
        echo '<script>window.alert("Item is already added");</script>';
        echo "<script>location.href='Sides.php'</script>";
      }
    }
    ?>
  </div>
